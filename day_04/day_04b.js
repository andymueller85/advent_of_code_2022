...
const declareWinnerWhichIsReallyTheLoser = (board, lastCalledNumber) => {
...
const playBingo = (currentBoards, calledNumberIndex = 0) => {
  ...
  if (
    ...
    declareWinnerWhichIsReallyTheLoser(remainingBoards[0], numbersDraw[calledNumberIndex])
  } else {
    playBingo(remainingBoards, calledNumberIndex + 1)
  }
}
